---
title: "Introduction_pearsonCorrelateCells"
...
**This document gives a tour of pearsonCorrelateCells (version 0.1.0)**. See `help(package = "pearsonCorrelateCells")` for further details.
...
In this example, we will be using the 10X Genomics Visium Mouse Brain Dataset from SeuratData as our spatial transcriptoic dataset to analyze (Cite). We will be using the topOligoGenes dataset included in this package as the comparator. The topOligoGenes dataset is a dataframe generated from extracting oligodendrocyte gene expression from the reference scRNA-seq dataset of ~14,000 adult mouse cortical cell taxonomy from the Allen Institute (Cite).
...
[Lam, W. (2022) Compare Pseudogenes. Unpublished.](https://github.com/jessielam415/pearsonCorrelateCells)
